...
\node[anchor=west] at (0,0) {%
  ...
  \fbox{\parbox[c][6cm][c]{6cm}{\centering \includegraphics[width=6cm]{logo_universidad.png}}}
};
\node[anchor=east] at (\linewidth,0) {%
  % ---- logo de la facultad ----
  \fbox{\parbox[c][6cm][c]{6cm}{\centering \includegraphics[width=6cm]{logo_facultad.png}}}
};
...
\textit{El fine-tuning no mejoró la segmentación: el Dice disminuyó de 0.283 a 0.162 y el IoU de 0.165 a 0.089. Las predicciones presentaron dificultades para delimitar con precisión los bordes de las lesiones. La elevada exactitud por píxel (99.88\%) debe interpretarse con cautela debido al desbalance entre fondo y caries. El reducido tamaño del conjunto de datos limita la generalización del modelo, por lo que se recomienda ampliar los datos y evaluar otras arquitecturas y estrategias de entrenamiento.}
\end{block}
